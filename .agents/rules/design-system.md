---
name: Izi Facture Design System
description: Règle stricte pour le design system "Notion Style" de l'application Izi Facture. Obligatoire pour toutes les nouvelles pages et composants.
---
